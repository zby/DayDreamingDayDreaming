...
* `data/`: inputs/outputs (`1_raw/`, `2_tasks/`, `gens/`, `cohorts/`, `7_cross_experiment/`) — **never commit secrets or proprietary outputs**. Cohort runs write into `data/cohorts/<id>/reports/{parsing,summary,analysis}`; cross-experiment rebuilds live under `7_cross_experiment/`.
