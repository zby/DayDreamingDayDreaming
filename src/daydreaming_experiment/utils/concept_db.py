...
class ConceptDB:
    ...
    def __init__(self, concepts: List[Concept] = None):
        ...
        self._concept_by_id = {concept.concept_id: concept for concept in self._concepts}

    def add_concept(self, concept: Concept) -> None:
        """Add a concept to the database."""
        self._concepts.append(concept)
        self._concept_by_id[concept.concept_id] = concept
    ...
    def get_concept_by_id(self, concept_id: str) -> Concept:
        """Get a concept by ID."""
        if concept_id not in self._concept_by_id:
            raise KeyError(f"Concept ID '{concept_id}' not found")
        return self._concept_by_id[concept_id]
    ...
    def save(self, manifest_path: str, articles_dir: str = "articles") -> None:
        ...
        manifest = {"version": "1.0", "articles_dir": articles_dir, "concepts": []}
    ...
    def load(cls, manifest_path: str) -> "ConceptDB":
        ...
        for concept_data in manifest["concepts"]:
            ...
            concept = Concept(
                concept_id=concept_data.get("concept_id", concept_data["name"].lower().replace(" ", "-")),
