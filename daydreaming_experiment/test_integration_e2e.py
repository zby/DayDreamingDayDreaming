    ...
    def test_evaluation_phase_integration(
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with open(results_file, 'w', newline='') as f:
                ...
                writer.writerow([
                    "test_eval_integration", "1", "concept1|concept2", "2",
                    "paragraph", "0", "response_001.txt", "2025-07-29T12:00:00",
                    "test-model"
                ])
            ...
            with open(response_file, 'w') as f:
                f.write("Test response with iterative creative loops and meta-cognitive awareness.")
    ...
    def test_analysis_phase_integration(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with open(gen_exp_dir / "results.csv", 'w', newline='') as f:
                writer = csv.writer(f)
                writer.writerow(["experiment_id", "concept_names", "concept_count", "response_file"])
                writer.writerow(["gen_only_test", "concept1|concept2|concept3", "3", "resp1.txt"])
                writer.writerow(["gen_only_test", "concept4|concept5|concept6", "3", "resp2.txt"])
            ...
            with open(eval_exp_dir / "evaluation_results.csv", 'w', newline='') as f:
                ...
                writer.writerow([
                    ...
                    "concept_names", "concept_count", "template_id"
                ])
            ...
            result = runner.invoke(analyze_results, [
                str(eval_exp_dir), 
                "--min-confidence", "0.9"
            ])
    ...
    def test_evaluation_with_nonexistent_template(self, mock_client_class, mock_load_dotenv):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with open(exp_dir / "results.csv", 'w', newline='') as f:
                ...
                writer.writerow([
                    "template_test", "1", "concept1|concept2", "2", "paragraph", "0",
                    "test_response.txt", "2025-07-29T12:00:00", "test-model"
                ])
    ...
    def test_csv_format_compatibility(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with open(exp_dir / "results.csv", 'w', newline='') as f:
                ...
                writer.writerow([
                    "test", "1", "c1|c2", "2", "paragraph", "0", 
                    "resp.txt", "2025-01-01T00:00:00", "model"
                ])
