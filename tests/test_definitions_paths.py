...
from daydreaming_dagster.resources.io_managers import CohortCSVIOManager, RehydratingIOManager
...
def test_definitions_respect_custom_data_root(definitions_with_paths):
    ...
    draft_response_manager = defs.resources["draft_response_io_manager"]
    assert isinstance(draft_response_manager, RehydratingIOManager)
